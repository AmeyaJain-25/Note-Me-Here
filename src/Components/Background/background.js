        ...
        return(
            <div className='background-container'>
                <div className='top-part'>
                    ...
                    <h4 className='title'><span className='title1'>NOTE</span> <span className='title2'>ME</span> <span className='title3'>HERE</span></h4>
                ...
                <div className='bottom-part'>
                    {
                        this.state.note.map((elements)=>{
                            return(
                                <NoteCard key={elements} noteText={elements}/>
                            );
                        })
                    }
                </div>
